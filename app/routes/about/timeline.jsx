              ...
              {events.map((event, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="w-8 h-8 rounded-full text-white flex items-center justify-center ring-8 ring-white z-20 md:mx-6 my-4" style={{ backgroundColor: "#e8d8b5" }}>
                      <span className="text-xs font-bold uppercase">{event.icon}</span>
                    </div>
                  </motion.li>
                );
              })}
